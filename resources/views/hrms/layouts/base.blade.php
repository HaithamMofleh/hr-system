...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/js/plugins/select2/css/select2.min.css') }}">
...
<script src="{{ URL::asset('assets/js/plugins/select2/js/select2.min.js') }}"></script>
