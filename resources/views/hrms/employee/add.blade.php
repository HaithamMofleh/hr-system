            ...
            <section id="content" class="animated fadeIn">
                ...
                <div class="mw1000 center-block">
                    ...
                    <div class="allcp-form">
                        ...
                        <form class="add-employee-form" method="post" action="@if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}') {{ route('edit-emp', ['id'=>$emps->id]) }} @else  {{ route('add-employee') }} @endif">
                            ...
                            <div class="wizard steps-bg steps-left">
                                ...
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        ...
                                        <label for="input002" class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                            <input type="email" name="email" id="emp_name" class="gui-input"
                                    ...
                                    <div class="section">
                                        <label for="input002">
                                            <h6 class="mb20 mt40">Employee password </h6>
                                        </label>
                                        <label for="input002" class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                            <input type="password" name="password" id="emp_name" class="gui-input"
                                    ...
                                    <div class="section">
                                        <button type="submit" class="btn btn-bordered btn-info btn-block">Save</button>
                                    </div>
                                    <!-- -------------- /section -------------- -->
                                </section>
                            </div>
